...
# --- Sécurité / environnements ---
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'dev-unsafe-key')
DEBUG = os.environ.get('DEBUG', 'True') == 'True'

# En dev on garde localhost, en prod tu AJOUTERAS ton domaine (PA, etc.)
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '127.0.0.1,localhost').split(',')

# Si tu déploies sur PythonAnywhere, ajoute :
...
# --- CORS (API consommée par ton front) ---
# En dev on ouvre; en prod, remplace par ton domaine de front.
...
# --- Static & Media (utile pour PythonAnywhere) ---
STATIC_URL = '/static/'
